...
Project Showcase: Highlights key applications and games including MyDiaryApp (.NET MAUI & SQL Server), DragonJourney (Game Jam 2nd Place), and Pixel Prodigy (Godot engine 8-bit game).  Skills Breakdown: Visualizes technical proficiency in Java, C#, Python, HTML/CSS, and office productivity tools using custom percentage bars.
...
Icons: Boxicons.  Fonts: Google Fonts (Poppins).  
Hosting & Deployment: Netlify. 
portfolio-website/
├── index.html        # Main HTML structure and content
├── style.css         # Styling, layout, animations, and color scheme
├── script.js         # Mobile menu toggle, scroll tracking, and typewriter effect
├── main.jpeg         # Profile image asset
└── Nyengedzo Jonathan Cherane's CV.pdf  # Downloadable resume document
